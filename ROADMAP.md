...
- 홈 첫 화면을 신뢰형 레이아웃으로 재정렬: 장식 강도 축소, 실사용 카피 강화, "실제 사용 흐름(기록-구조화-공유)" 카드 추가.
...
- GitHub `main` 브랜치 보호 규칙에 `RBAC Policy Check / rbac` 상태검사 및 Code Owner 리뷰 필수 조건을 연결해 merge 차단을 완성함.
